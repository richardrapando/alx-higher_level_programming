ass inheriting from Base class."""
...
class Rectangle(Base):
    ...
    def area(self):
        """Returns value of Rectangle instance."""
    ...
    def __str__(self):
        """Return str() and print() representation of the Rectangle."""
