...
class Base:
    """Represents the base of other classes.
    ...
    def save_to_file(cls, list_objs):
        ...
        Args:
            list_objs (list): list of Base instances that are inherited
        """
    ...
    def from_json_string(json_string):
        """Return the conversion from a JSON string.
        Args:
            json_string (str):JSON string representation of a list of dictionaries.
        Returns:
            Empty list - If JSON string is None or empty
    ...
    def create(cls, **dictionary):
        """Return class from a dictionary of attributes.
        Args:
            **dictionary (dict): value pairs of attributes to be initialized.
        """
    ...
    def load_from_file(cls):
        """Return list of instantiated classes
    ...
    def save_to_file_csv(cls, list_objs):
        """write CSV representation of a list of objects to a file.
        Args:
    ...
    def draw(list_rectangles, list_squares):
        """draw Squares and Rectangles using turtle module.
        Args:
